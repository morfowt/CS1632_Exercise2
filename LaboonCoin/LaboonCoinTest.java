...
public class LaboonCoinTest {
	...
	public void testHashValue() {
		int hashValue = _l.hash("CS1632");
		assertEquals(0xAD634260, hashValue);
	}
	
	@Test
	public void testHashNull() {
		int hashValue = _l.hash(null);
		assertEquals(0x00989680, hashValue);
	}
	
	@Test
	public void testHashConstant() {
		int hashValue1 = _l.hash("bill");
		int hashValue2 = _l.hash("bill");
		assertEquals(hashValue1, hashValue2);
	}
	
	@Test
	public void testValidHash() {
		assertTrue(_l.validHash(4, 0x0000ffff));
	}
	
	@Test
	public void testInvalidHash() {
		assertFalse(_l.validHash(5, 0x0000ffff));
	}

	@Test
	public void testDifficultyNine() {
		assertFalse(_l.validHash(9, 0));
	}
}
